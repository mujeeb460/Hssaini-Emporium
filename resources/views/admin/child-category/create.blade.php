...
@section('content')
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title">Create Child Category</h4>
                        </div>
                    </div>
                </div>
                <!-- end page title -->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="card-box">
                            ...
                            {!! Form::open(['route' => ['admin.child_category.store'], 'files' => true]) !!}
                            <div class="row">
    ...
    document.addEventListener('livewire:load', function () {
        Livewire.on('categoryUpdated', (selectedCategory, selectedSubcategory) => {
